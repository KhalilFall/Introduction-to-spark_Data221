...
val prod = smallNumber * NombreAssezGrand
val add  = pi + 2
...
// MAGIC %md ### Les tuples // UC: wanna make a function wich return multiple values, or have multiple args as input
